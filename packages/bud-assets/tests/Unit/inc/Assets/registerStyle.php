...
/**
 * @covers \LaunchpadBudAssets\Assets::register_style
 */
class Test_registerStyle extends TestCase {
    ...
    {
        $this->assets->register_style($config['key'], $config['url'], $config['dependencies'], $config['media']);
    }
}
